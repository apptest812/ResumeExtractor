"""
Django settings for resume_scanner_api project.
...
MIDDLEWARE = [
    ...
    "api.middleware.login_middleware.APIRequestMiddleware"
]
...
WSGI_APPLICATION = "resume_scanner_api.wsgi.application"
